	...
	return (
		<section className="portfolio container section" id="portfolio">
			...
			<div className="portfolio__filters">
				...
				<span className={activeFilter === 1 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Laravel"); setActiveFilter(1) }}>
					Laravel
				</span>
				<span className={activeFilter === 2 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Express"); setActiveFilter(2) }}>
					ExpressJs
				</span>
				<span className={activeFilter === 3 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Other"); setActiveFilter(3) }}>
					Other
				</span>
			</div>
